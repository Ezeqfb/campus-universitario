        ...
        <div class="seccion">
            ...
            if (!empty($_GET['id_tarea'])) {
                ...
                if ($resultado->num_rows == 1) {
                    ...
                    echo "<a class='btn btn-primary' href='modificar_tarea.php?id_tarea=".$id_tarea."'>Modificar</a>
                    <a class='btn btn-primary' href='eliminar_tarea.php?id_tarea=".$id_tarea."'>Eliminar</a>
                    <a class='btn btn-primary' href='pagina_profesor.php'>Volver</a>";
                } else {
