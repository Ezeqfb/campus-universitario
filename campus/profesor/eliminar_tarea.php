        ...
        <div class="seccion">
            ...
            if (!empty($_GET['id_tarea'])) {
                ...
                if ($resultado->num_rows == 1) {
                    ...
                    echo "<p><strong>¿Estás seguro de que deseas eliminar esta tarea?</strong></p>";
                    echo "<a class='btn btn-danger' href='../php/eliminar_tarea.php?id_tarea=".$id_tarea."'>Eliminar</a>
                          <a class='btn btn-secondary' href='detalle_tarea.php?id_tarea=".$id_tarea."'>Cancelar</a>";
                } else {
