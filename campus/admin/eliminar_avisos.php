    ...
    <div class="seccion">
        ...
        if(isset($_GET['id']) && filter_var($_GET['id'], FILTER_VALIDATE_INT)) {
            ...
            if (isset($_POST['submit'])) {
                // Preparar la consulta para eliminar el aviso
                ...
                if ($stmt->execute()) {
                    echo "<div class='alert alert-success' role='alert'>El aviso se eliminó con éxito.</div>";
                    echo "<a class='btn btn-primary' href='admin_avisos.php'>Regresar a la lista de avisos</a>";
                } else {
                    echo "<div class='alert alert-danger' role='alert'>Error al eliminar el aviso: " . $stmt->error . "</div>";
                }

                // Cerrar la sentencia preparada
                $stmt->close();
            } else {
                echo "<p>¿Está seguro de que desea eliminar este aviso?</p>";
